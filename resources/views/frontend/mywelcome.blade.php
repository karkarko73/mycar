...
<head>
    ...
    <link rel="icon" href="{{ asset('uploads/icon/icon.png') }}">
        ...
        <section id="services">
            <div class="container wow fadeIn">
                <div class="section-header">
                    ...
                    <p class="section-description">You can buy or sell your cars by posting with our site.This website
                        is use by million of users in Myanmar.</p>
                </div>
