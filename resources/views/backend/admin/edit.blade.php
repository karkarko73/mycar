...
<div class="container">
    ...
    <nav class="navbar navbar-light">
        <a href="{{ url("admin/post/$product->id/show") }}"><button class="btn btn-sm btn-info float-right"><i
                    class="fas fa-arrow-circle-left mr-2"></i>Back</button></a>
        <form action="{{ url("admin/post/$product->id/edit") }}" method="POST" enctype="multipart/form-data">
            @csrf
