...
<div class="container">
    <div class="container">
        <nav class="navbar navbar-light">
            <a href="{{ url("admin/post") }}"><button class="btn btn-sm btn-info float-right"><i class="fas fa-arrow-circle-left mr-2"></i>Back</button></a>
            <a href="{{ url("admin/post/$product->id/edit") }}" class="btn btn-sm btn-secondary"><i
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url("user/deletecomment/$comment->id") }}"
                                        class="btn btn-sm btn-danger"><i class="fas fa-trash-alt mr-2"></i>Delete</a>
                                </td>
                            </tr>
                            @endforeach
