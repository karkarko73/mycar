        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="{{ url("admin/user/$data->id/delete") }}" onclick="return confirm('Warning(Not to delete) : That will be delete all posts you had created!')" class="btn btn-danger"><i class="fas fa-trash-alt">Delete User</i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
