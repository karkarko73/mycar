                    ...
                    <div class="card-body">
                        ...
                        <!-- Button -->
                            <div class="row justify-content-between">
                                <a href="{{ url("user/personalproducts") }}" class="btn btn-info"><i class="fas fa-arrow-circle-left">Back</i></a>
                                <a href="{{ url("user/personalproducts/$product->id/edit") }}" class="btn btn-warning"><i class="fas fa-edit">Edit</i></a>
