...
<div class="container">
    <div class="container">
        <nav class="navbar navbar-light">
            <a href="{{ url("user/personalproducts") }}"><button class="btn btn-sm btn-info float-right"><i
                        class="fas fa-arrow-circle-left mr-2"></i>Back</button></a>
            <a href="{{ url("user/personalproducts/$product->id/edit") }}" class="btn btn-sm btn-secondary"><i
